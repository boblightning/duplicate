                        ...
                        <div className="col-6 p-5 rounded" style={{ display:"flex", margin:"auto" }}>
                            <Card
                                ...
                                <FormGroup style={{ textAlign: "center" }}>
                                    <h3 style={{color:"black", margin:"10px", marginBottom:"30px"}}>Create Account</h3>
                                ...
                                <FormGroup style={{ textAlign: "center" }}>
                                    ...
                                    <InputGroup style={{ textAlign: "center" }}>
                                        <Input type={this.state.passType} placeholder='Confirm Password' id="confTextPassword" innerRef={(element) => this.confPassword = element} />
                                        <InputGroupText style={{ cursor: "pointer", width: "70px" }} onClick={this.showHidePassword}>
                                            {this.state.passText}
                                        </InputGroupText>
                                    </InputGroup>
